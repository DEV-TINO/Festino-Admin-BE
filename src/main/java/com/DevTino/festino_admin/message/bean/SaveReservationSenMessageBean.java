...
public class SaveReservationSenMessageBean {
    ...
    @Autowired
    public SaveReservationSenMessageBean(GetAccessTokenBean getAccessTokenBean, SendMessageBean sendMessageBean, CheckMessageStatusBean checkMessageStatusBean) {

...
public class CompleteReservationSendMessageBean {
    ...
    @Autowired
    public CompleteReservationSendMessageBean(GetAccessTokenBean getAccessTokenBean, SendMessageBean sendMessageBean, CheckMessageStatusBean checkMessageStatusBean) {

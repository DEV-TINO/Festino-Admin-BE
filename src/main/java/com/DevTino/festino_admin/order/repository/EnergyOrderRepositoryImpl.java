...
public class EnergyOrderRepositoryImpl implements OrderRepository<EnergyOrderDAO>{
    ...
    // 테이블 번호에 따른 주문 검색
    public List<EnergyOrderDAO> findByDateAndCreateAtAfterOrderByTableNumAscCreateAtAsc(Integer date, LocalDateTime after){

        return energyOrderRepositoryJPA.findByDateAndCreateAtAfterOrderByTableNumAscCreateAtAsc(date, after);
    }

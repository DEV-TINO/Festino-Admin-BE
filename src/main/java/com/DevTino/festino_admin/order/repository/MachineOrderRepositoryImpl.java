...
public class MachineOrderRepositoryImpl implements OrderRepository<MachineOrderDAO>{
    ...
    // 테이블 번호에 따른 주문 검색
    public List<MachineOrderDAO> findByDateAndCreateAtAfterOrderByTableNumAscCreateAtAsc(Integer date, LocalDateTime after){

        return machineOrderRepositoryJPA.findByDateAndCreateAtAfterOrderByTableNumAscCreateAtAsc(date, after);
    }
